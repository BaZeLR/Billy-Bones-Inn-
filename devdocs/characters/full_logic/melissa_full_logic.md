# Full Logic Map: Мелисса

Source: only `game/Inn/*.txt` (authoritative content).

## Scope Summary
- Character id: melissa
- Tokens used for discovery: melissa, MelissaVar
...
- InitMelissa.txt => Location: InitMelissa
- IntAmandaDressChange.txt => Location: IntAmandaDressChange
- IntLizaDressChange.txt => Location: IntLizaDressChange
- IntMelissaDressChange.txt => Location: IntMelissaDressChange
- IntMelissaTalk.txt => Location: IntMelissaTalk
...
- IntMelissaDressChange.txt:6 | GS 'Menu.Add','MenuMelissaTalk','Предложить купить сестренке обновку',''
- IntMelissaTalk.txt:8 | GS 'Menu.Add','MenuMelissaTalk','Осмотреть',''
- IntMelissaTalk.txt:13 | GS 'Menu.Add','MenuMelissaTalk','Попробовать помириться с Мелиссой',''
...
- IntMelissaDressChange.txt:13 | gs 'Menu.AddCondition','MenuMelissaTalk', "Result=IIF(Friends[$GirlNameIMT]>8 and func('CheckDailyEventExists','','BuyDressTom')=0 and func('CheckDailyEventExists',$GirlNameIMT,'BuyDress')=0 and Talked[$GirlNameIMT]<2 and week<>6,-1,0)"
- IntMelissaTalk.txt:16 | if Rand(1,3)=1:
- IntMelissaTalk.txt:25 | gs 'Menu.AddCondition','MenuMelissaTalk', "Result=IIF(Talked[$GirlNameIMT]<3 and Friends[$GirlNameIMT]<5,-1,0)"
...
- DressNoShow.txt:50 | '"Ой, ты знаешь <<iif(DressBuyIsRelative=1,''мамусик'',iif(DressBuyIsRelative=2,''сестричка'',''котеночек''  ))>>, я забегался по делам и опоздал."<br>"По каким-таким делам ты с утра пораньше бегал?" недоуменно ответила <<$RealName[$GirlNameDNS]>>.<br>"Да, надо было там сделать кое-что." туманно объяснили вы. "Прости, я виноват. Не дуйся."<br>"Ну ладно, раз так, то давай будем считать, что мы перенесли наш поход на <<iif(week<>6,''завтра'',''понедельник'')>>." неожиданно ответила вам <<$RealName[$GirlNameDNS]>>.<br>"Ну давай, " промямли вы, будучи застигнутым врасплох таким оборотом дел.<br>"Вот и ладушки, утром, как всегда!" сказала повеселевшая <<$RealName[$GirlNameDNS]>> и убежала.<br>'
- InitMelissa.txt:20 | $CurrentLoc[$GirlName]='TavernMain'
- InitMelissa.txt:40 | jobkitchen[$GirlName]=0
- InitMelissa.txt:41 | jobcleaning[$GirlName]=1
- InitMelissa.txt:42 | jobwaitress[$GirlName]=1
- InitMelissa.txt:46 | jobWhoreAvail[$GirlName]=0
- InitMelissa.txt:47 | jobwhore[$GirlName]=0
- InitMelissa.txt:48 | jobgloryhole[$GirlName]=0
- IntAmandaDressChange.txt:9 | if $CurrentLoc['liza']<>'TavernMain' and RandVar=4 :RandVar=Rand(5,7)
- IntAmandaDressChange.txt:10 | if $CurrentLoc['georgett']<>'TavernMain' and RandVar=3 :RandVar=Rand(5,7)
- IntAmandaDressChange.txt:71 | if $CurrentLoc['liza']='TavernMain':
- IntAmandaDressChange.txt:94 | if $CurrentLoc['liza']='TavernMain':
...
- menu_tavernstat.txt:64 | GS 'Menu.Add',$GirlMenuName,'<<func(''JobMenuDesc'',jobkitchentomorrow[''melissa''],1)>>',''
- menu_tavernstat.txt:66 | jobkitchentomorrow['melissa']=(jobkitchentomorrow['melissa']+1) mod 2
- menu_tavernstat.txt:69 | GS 'Menu.Add',$GirlMenuName,'<<func(''JobMenuDesc'',jobcleaningtomorrow[''melissa''],2)>>',''
- menu_tavernstat.txt:71 | jobcleaningtomorrow['melissa']=(jobcleaningtomorrow['melissa']+1) mod 2
- menu_tavernstat.txt:75 | GS 'Menu.Add',$GirlMenuName,'<<func(''JobMenuDesc'',jobwaitresstomorrow[''melissa''],3)>>',''
- menu_tavernstat.txt:77 | jobwaitresstomorrow['melissa']=(jobwaitresstomorrow['melissa']+1) mod 2
- SetTavernServiceLevels.txt:7 | melissadiv=jobkitchen['melissa']+jobcleaning['melissa']+jobwaitress['melissa']
...
- InitMelissa.txt:50 | MelissaVar['MomDressComplaint']=0

## Full Matched Line Index (exhaustive)
- $menu_f.txt:9 | gs 'GirlsDesc','melissa'
- AdjustOtkroven.txt:18 | elseif $GirlNameAOtk='amanda' or $GirlNameAOtk='melissa' or $GirlNameAOtk='sandra':
- AmandaAtHomeCode.txt:19 | gs 'SlutFriendsIncrease', 'melissa', 0, 1, -5, 0, 0, 0
- DailySetstatdefault.txt:65 | if $GirlName='amanda' or $GirlName='melissa':
- DressNoShow.txt:9 | if $GirlNameDNS='melissa' or $GirlNameDNS='amanda':DressBuyIsRelative=2
- DressNoShow.txt:25 | elseif $GirlNameDNS='melissa':
- EllonaBirthPrayMenu.txt:73 | if $GirlName='liza' or $GirlName='melissa' or $GirlName='amanda':
...
- HarassDiscussImage.txt:6 | if $args[0]='melissa':
- HarassShowImage.txt:12 | if $GirlNameHSI='melissa':
- InitMelissa.txt:1 | Location: "InitMelissa"
- InitMelissa.txt:6 | $GirlName='melissa'
- InitMelissa.txt:50 | MelissaVar['MomDressComplaint']=0
- InitMelissa.txt:52 | ------------ End of location: "InitMelissa" ------------
- IntAmandaDressChange.txt:20 | if sluttiness['melissa']>=35:
- IntLizaDressChange.txt:18 | if sluttiness['melissa']>=35:
- IntMelissaDressChange.txt:1 | Location: "IntMelissaDressChange"
- IntMelissaDressChange.txt:6 | GS 'Menu.Add','MenuMelissaTalk','Предложить купить сестренке обновку',''
- IntMelissaDressChange.txt:7 | GS 'Menu.AddModule','MenuMelissaTalk',{
- IntMelissaDressChange.txt:13 | gs 'Menu.AddCondition','MenuMelissaTalk', "Result=IIF(Friends[$GirlNameIMT]>8 and func('CheckDailyEventExists','','BuyDressTom')=0 and func('CheckDailyEventExists',$GirlNameIMT,'BuyDress')=0 and Talked[$GirlNameIMT]<2 and week<>6,-1,0)"
- IntMelissaDressChange.txt:15 | ------------ End of location: "IntMelissaDressChange" ------------
- IntMelissaTalk.txt:1 | Location: "IntMelissaTalk"
- IntMelissaTalk.txt:6 | $GirlNameIMT='melissa'
- IntMelissaTalk.txt:7 | GS 'Menu.Create','MenuMelissaTalk'
- IntMelissaTalk.txt:8 | GS 'Menu.Add','MenuMelissaTalk','Осмотреть',''
- IntMelissaTalk.txt:9 | GS 'Menu.AddModule','MenuMelissaTalk',{
- IntMelissaTalk.txt:13 | GS 'Menu.Add','MenuMelissaTalk','Попробовать помириться с Мелиссой',''
- IntMelissaTalk.txt:14 | GS 'Menu.AddModule','MenuMelissaTalk',{
- IntMelissaTalk.txt:25 | gs 'Menu.AddCondition','MenuMelissaTalk', "Result=IIF(Talked[$GirlNameIMT]<3 and Friends[$GirlNameIMT]<5,-1,0)"
- IntMelissaTalk.txt:27 | gs 'IntMelissaDressChange'
- IntMelissaTalk.txt:29 | ------------ End of location: "IntMelissaTalk" ------------
- Intro.txt:83 | $AllGirlNames[1]='melissa'
- KidsFunctions.txt:72 | if $MomName='sandra' or $MomName='melissa' or $MomName='amanda':
- KidsFunctions.txt:74 | gs 'Table.DeleteLines','TodaySexEvents', 'GirlName','=','melissa'
- KidsFunctions.txt:90 | if $MomName='amanda'  or $MomName='melissa' or $MomName='sandra':
- menu_tavernstat.txt:61 | $GirlMenuName='MenuMelissaJob'
- menu_tavernstat.txt:64 | GS 'Menu.Add',$GirlMenuName,'<<func(''JobMenuDesc'',jobkitchentomorrow[''melissa''],1)>>',''
- menu_tavernstat.txt:66 | jobkitchentomorrow['melissa']=(jobkitchentomorrow['melissa']+1) mod 2
- menu_tavernstat.txt:69 | GS 'Menu.Add',$GirlMenuName,'<<func(''JobMenuDesc'',jobcleaningtomorrow[''melissa''],2)>>',''
- menu_tavernstat.txt:71 | jobcleaningtomorrow['melissa']=(jobcleaningtomorrow['melissa']+1) mod 2
- menu_tavernstat.txt:75 | GS 'Menu.Add',$GirlMenuName,'<<func(''JobMenuDesc'',jobwaitresstomorrow[''melissa''],3)>>',''
- menu_tavernstat.txt:77 | jobwaitresstomorrow['melissa']=(jobwaitresstomorrow['melissa']+1) mod 2
- menu_tavernstat.txt:164 | pl '<a href="exec: GS ''Menu.Call'',''MenuMelissaJob''">Мелисса</a>'
- MorningSickness.txt:84 | if $GirlName='amanda' or $GirlName='melissa':
- NextDay_TavernDaily.txt:105 | gs 'ChangeTommorowHallJob', 'melissa'
- NextDay.txt:185 | gs 'DescribeSkillIncrease', 'melissa'
- RelationshipDesc1.txt:11 | elseif $GirlNameRD1='amanda' or $GirlNameRD1='melissa':
- SetTavernServiceLevels.txt:7 | melissadiv=jobkitchen['melissa']+jobcleaning['melissa']+jobwaitress['melissa']
- SetTavernServiceLevels.txt:10 | if melissadiv=0:melissadiv=1
- SetTavernServiceLevels.txt:13 | tavernkitchen=jobkitchen['sandra']*cooking['sandra']/sandradiv+jobkitchen['melissa']*cooking['melissa']/melissadiv+jobkitchen['amanda']*cooking['amanda']/amandadiv
...
- SetTavernServiceLevels.txt:53 | tavernwaitress=jobwaitress['sandra']*waitress['sandra']/sandradiv+jobwaitress['melissa']*waitress['melissa']/melissadiv+jobwaitress['amanda']*waitress['amanda']/amandadiv
- SetTavernServiceLevels.txt:54 | tavernwaitress=Min(tavernwaitress,Max(jobwaitress['sandra']*waitress['sandra'],jobwaitress['melissa']*waitress['melissa'],jobwaitress['amanda']*waitress['amanda']))
- TavernMain.txt:49 | gs 'IntMelissaTalk'
...
- TavernMain.txt:133 | gs 'CheckDailyEvent', 'melissa'
- TavernMain.txt:137 | dynamic $DescribeBreastFeeding, 'melissa'
...
- TavernShowImage.txt:12 | gs 'ShowImage', 'melissa', 'tavern', 'waitress' + Rand(1,3)
