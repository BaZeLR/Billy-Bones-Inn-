...
init 100 python:
    ...
    def _amanda_bp_cur_loc():
        return str(CurLoc or "")

    def _amanda_bp_has_sex_event(place_name=""):
        cur_time = _amanda_bp_i(time, 0)
        return _amanda_bp_i(CheckIfSexEventExist("amanda", cur_time, place_name), 0) > 0

    def amanda_bp_tavern_entry_ready():
        return bool(story_amanda_tavern_entry_ready())

    def amanda_bp_street_entry_ready():
        return bool(story_amanda_street_entry_ready())

    def amanda_bp_market_entry_ready():
        return bool(story_amanda_market_entry_ready())
    ...
    def amanda_bp_legare_dance_ready():
        return _amanda_bp_legare_arc_ready() and _amanda_bp_i(week, 0) == 5
    ...
    def amanda_bp_dress_ready():
        return _amanda_bp_var("MomDressComplaint") > 0 or _amanda_bp_i(Amanda.corruption, 0) >= 20
    ...
    def amanda_bp_pregnancy_talk_ready():
        return _amanda_bp_i(Amanda.pregnancy_days(), 0) >= 120 or _amanda_bp_var("askzalettoday") == 0

    def amanda_bp_event(target, day, hour, evt_day, probability, requirements, conditions, item, location, action, priority):
        return Event(
            (
                target,
                day,
    ...
    def build_amanda_thread_blueprint():
        random_threads = [
            RThreadData(0, "amanda", "AmbientRandom", None, (4,
                [
                    amanda_bp_event("story_amanda_tavern_entry", None, None, None, 1, None, "amanda_bp_tavern_entry_ready()", None, "TavernMain", "enter", 0),
                    amanda_bp_event("story_amanda_street_entry", None, None, None, 1, None, "amanda_bp_street_entry_ready()", None, "StreetTavern", "enter", 0),
                    amanda_bp_event("story_amanda_market_entry", None, None, None, 1, None, "amanda_bp_market_entry_ready()", None, "MarketPlace", "enter", 0),
                    amanda_bp_event("amanda_bp_glory_try", None, None, None, 1, None, "amanda_bp_glory_try_ready()", None, "TavernMain", "enter", 5),
                ]),
                highlight=False,
                threaded=False,
            ),
        ...
        linear_threads = [
            LThreadData(0, "amanda", "LizaArc", None, [
                amanda_bp_event("amanda_bp_liza_intro", None, None, None, 1, None, "amanda_bp_liza_arc_ready()", None, "TavernMain", "talk", 0),
                amanda_bp_event("amanda_bp_liza_glory", None, None, None, 1, None, "amanda_bp_liza_glory_ready()", None, "TavernMain", "talk", 0),
            ], highlight=True),
            LThreadData(0, "amanda", "LegareArc", None, [
                amanda_bp_event("amanda_bp_legare_talk", None, None, None, 1, None, "amanda_bp_legare_arc_ready()", None, "TavernMain", "talk", 0),
                amanda_bp_event("amanda_bp_legare_dance", 5, None, None, 1, None, "amanda_bp_legare_dance_ready()", None, "FridayDance", "enter", 0),
                amanda_bp_event("amanda_bp_legare_aftermath", None, None, None, 1, None, "amanda_bp_legare_aftermath_ready()", None, "TavernMain", "talk", 0),
                amanda_bp_event("amanda_bp_legare_sex", None, None, None, 1, None, "amanda_bp_legare_sex_ready()", None, "TavernMain", "talk", 0),
            ], highlight=True),
            LThreadData(0, "amanda", "DressArc", None, [
                amanda_bp_event("amanda_bp_dress_intro", None, None, None, 1, None, "amanda_bp_dress_ready()", None, "TavernMain", "talk", 0),
                amanda_bp_event("amanda_bp_dress_room", None, None, None, 1, None, "amanda_bp_room_ready()", None, "TavernAmandaRoom", "enter", 0),
            ], highlight=True),
        ]

        unordered_threads = [
            UThreadData(0, "amanda", "TalkStates", None, [
                amanda_bp_event("amanda_bp_warn_not_work", None, None, None, 1, None, "amanda_bp_warn_not_work_ready()", None, "TavernMain", "talk", 5),
                amanda_bp_event("amanda_bp_boys_talk", None, None, None, 1, None, "amanda_bp_boys_talk_ready()", None, "TavernMain", "talk", 10),
                amanda_bp_event("amanda_bp_virginity_talk", None, None, None, 1, None, "amanda_bp_virginity_talk_ready()", None, "TavernMain", "talk", 15),
                amanda_bp_event("amanda_bp_pregnancy_talk", None, None, None, 1, None, "amanda_bp_pregnancy_talk_ready()", None, "TavernMain", "talk", 20),
            ], highlight=False),
        ]
