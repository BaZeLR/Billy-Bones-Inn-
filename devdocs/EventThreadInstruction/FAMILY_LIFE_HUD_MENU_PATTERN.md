...
`main_ui_set_action_panel`, generic queues, refresh labels, rebuild labels,
dispatcher labels, or modal event screens. Those are legacy/bloat patterns, not
the blueprint.
...
- `current_action_items` used for authored story-event choices.
