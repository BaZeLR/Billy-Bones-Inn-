...
define melissaThreadList = [
    ...
    LThreadData(0, "melissa", "OintmentIntimacy", [
        ...
        (
            ...
            1, None,
            [
                "#bool(player.tavern_management.breakfast.today)",
                "#not bool(player.tavern_management.breakfast.event_active)",
                "#people.is_awake('amanda')",
                "#people.is_awake('melissa')",
                "#people.is_awake('liza')",
                "#str(people.location('amanda') or '') == str(rooms.current_code or '')",
                "#str(people.location('melissa') or '') == str(rooms.current_code or '')",
                "#str(people.location('liza') or '') == str(rooms.current_code or '')",
...
define claraThreadList = [
    ...
    LThreadData(0, "clara", "MongolAccusation", None, [
        (
            "story_clara_mongol_accusation",
            None, None, None, 1, None,
            [
                "#threads['claraBookletMarket'].done[2]",
                "#rooms.get('CityGuard').is_open()",
                "#str(people.location('zimmer') or '') == 'CityGuard'",
                "#not Clara.fiance_case_detained()",
            ],
            None, "talk_zimmer", "clara_mongol_accusation", 0, True,
        ),
        (
            "story_clara_mongol_custody",
            None, (21, 23), None, 1, None, None,
            None, "menu_CityGuard", "clara_custody", 0, True,
        ),
        (
            "story_clara_mongol_custody",
            None, (21, 23), None, 1, None, None,
        ...
        (
            "story_clara_mongol_tavern_arrival",
            None, None, None, 1, None, None,
            None, "TavernMain", "enter", 20, True,
        ),
    ], highlight=False, threaded=True),
    ...
    LThreadData(1, "clara", "PaintingsPath", None, [
        ...
        (
            ...
            1,
            None,
            ["#not Clara.mongol_case_detained()", "#Mongol.stocks_arrest_day >= 0"],
            None,
            "Church",
            "clara_paintings",
            6,
    ...
    # After Clarissa has moved in, completed the earlier locked-room visits,
    # and chosen to trust the player, this event establishes consent once.
    # Repeatable intimacy remains in HouseholdSexEngine.
    LThreadData(0, "clara", "PrivateGames", [
        "#threads['claraPaintingsPath'].completed",
        "#(int(threads['claraTavernVisit'].num or 0) >= 6 or bool(threads['claraTavernVisit'].completed))",
    ], [
        (
            "story_clara_private_games_0",
            None, None, None,
            1,
            None,
            [
                ...
                "#people.can_talk('clara')",
                "#not Clara.sex_busy()",
                "#Clara.relationship_allows('private_talk')",
                "#Clara.can_have_sex_today()",
