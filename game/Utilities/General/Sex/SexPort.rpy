...
label SexPort(args0=0, args1=""):
    ...
    if GirlNameSP == "georgett":
        ...
        call BeginPaidSexModule(GirlNameSP, "PortStreets")
        call IntLizaSex(GirlNameSP, "street", "Вы заплатили Лизетте восемь мараведи и повели ее переулками в знакомую подворотню. Дойдя до места, вы прижали девчушку к стене и впились в ее губы сладким поцелуем.\n\nВы находитесь в переулке. Рядом с вами юная Лизетта.")
