...
label street_clients_watch_event:
    ...
    if girl_name == "liza":
        ...
        if SexEventType == 1:
            ...
            if not Alber.liza_encounter_seen:
                $ scene_runtime.text = "Вы видите, как Лизетта делает минет кому-то смутно вам знакомому. Вскоре этот кто-то поворачивается, и вы узнаете мессира Легаре, почтенного отца семейства. Виноторговец входит в раж, хватает девочку за косички и начинает буквально трахать ее рот. Когда он кончает, мулатка чуть было не давится хлынувшей ей в горло спермой."
                $ Alber.liza_encounter_seen = True
            else:
                $ scene_runtime.text = "Вы видите, как юная Лизетта в очередной раз делает минет почтенному отцу семейства, мессиру Легаре. Виноторговец входит в раж, хватает девочку за косички и начинает буквально трахать ее рот. Когда он кончает, мулатка чуть было не давится хлынувшей ей в горло спермой."
        ...
        if SexEventType == 1:
            ...
            $ scene_runtime.text = "Вы видите, как Жоржетта делает минет какому-то пацаненку. Тому это явно нравится, и он приговаривает: \"Тетенька, сладко-то как! Хорошо-то как, тетенька!\" Перед самым оргазмом он вытаскивает свой членик, и тугая струя измазывает хорошенькое личико Жоржетты."
            ...
            if Becky.home_visit_stage < 7:
                if not Eddie.seen_with_georgett:
                    ...
                    $ scene_runtime.text = "Вы видите Жоржетту с вашим приятелем Эдди, играющих в уже знакомую вам игру."
