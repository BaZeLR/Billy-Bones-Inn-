...
label street_clients_watch(client_type=1, girl_name="", event_time=None):
    ...
    if girl_name == "liza":
        ...
        if SexEventType == 1:
            ...
            $ _street_client_picture = build_media_ref(girl_name, "portevents", "event1_" + str(procedural_randint(1, 3, "street_client_liza_1_%s" % int(dayspassed or 0))))
        elif SexEventType == 2:
            ...
            $ _street_client_picture = build_media_ref(girl_name, "portevents", "event2_" + str(procedural_randint(1, 3, "street_client_liza_2_%s" % int(dayspassed or 0))))
            ...
            $ _street_client_picture = build_media_ref(girl_name, "portevents", "event3_" + str(procedural_randint(1, 4, "street_client_liza_3_%s" % int(dayspassed or 0))))
            ...
            $ _street_client_picture = build_media_ref(girl_name, "portevents", "event4_" + str(procedural_randint(1, 4, "street_client_liza_4_%s" % int(dayspassed or 0))))
    else:
        ...
        if SexEventType == 1:
            ...
            $ _street_client_picture = build_media_ref(girl_name, "portevents", "event1_" + str(procedural_randint(1, 3, "street_client_georgett_1_%s" % int(dayspassed or 0))))
        elif SexEventType == 2:
            ...
            $ _street_client_picture = build_media_ref(girl_name, "portevents", "event2_" + str(procedural_randint(1, 3, "street_client_georgett_2_%s" % int(dayspassed or 0))))
        elif SexEventType == 3:
            ...
            $ _street_client_picture = build_media_ref(girl_name, "portevents", "event3_" + str(procedural_randint(1, 3, "street_client_georgett_3_%s" % int(dayspassed or 0))))
        elif SexEventType == 99:
            ...
            $ _street_client_picture = build_media_ref(girl_name, "portevents", "event4_" + str(procedural_randint(1, 3, "street_client_georgett_4_%s" % int(dayspassed or 0))))
