    ...
    class AlberData(PeopleData):
        ...
        def __init__(self):
            super().__init__(
                ...
                default_location="",
                description="Мессир Альбер Легаре — хозяин винного погребка. Его жена Элоиза — профессиональная гувернантка; в их доме она держит пансион, где взрослые девушки учатся манерам и готовятся к будущей жизни в знатном обществе.",
