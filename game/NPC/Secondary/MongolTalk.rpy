...
label MongolTalk:
    python:
        MongolVar.setdefault("GypsyAsk", 0)
        MongolVar.setdefault("AskPriceIncr", 0)
        MongolVar.setdefault("ZimmerKnow", 0)
        MongolVar.setdefault("HorsePrice", 1000)
        MongolVar.setdefault("DiscountAsk", 0)
        MongolVar.setdefault("TheftAsk", 0)
        MongolVar.setdefault("AskSawStolen", 0)
        MongolVar.setdefault("SawStolen", 0)
        MongolVar.setdefault("WillTryToSteal", 0)
        MongolVar.setdefault("HorsesBought", 0)
