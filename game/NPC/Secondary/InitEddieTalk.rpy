init python:
    ...
    def eddie_talk_intro_text():
        if str(rooms.current_code or "") == "GroceryStore":
            text = "Сейчас за прилавком стоит Эдди, молодой управляющий лавкой вдовы Блэнкеншип. Это здоровый рыжий парень примерно вашего возраста. Бекки когда-то приютила его сиротой и выучила делу."
