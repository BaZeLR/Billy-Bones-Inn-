    ...
    while True:
        ...
        if not Hordus.known:
            ...
            if _hordus_item == "cursed_sofa_001":
                $ Sofa.installed = True
                $ scene_runtime.text = "Хордус принимает деньги и распоряжается доставить старинный диван в главную залу вашего трактира. — Если начнет ворчать, не пугайся. Прежний хозяин тоже жаловался… а потом внезапно уехал из города."
            else:
