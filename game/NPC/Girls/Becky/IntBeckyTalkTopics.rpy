...
label story_becky_talk_eddie_reaction_1(girl_name="becky", change_mind=0):
    ...
    if Becky.corruption <= 35 and not threads["beckyGerhardAdvice"].enabled:
        ...
        if not threads["beckyGerhardAdvice"].completed and int(threads["beckyGerhardAdvice"].num or 0) == 0:
        ...
        elif threads["beckyGerhardAdvice"].enabled and not threads["beckyGerhardAdvice"].completed and int(threads["beckyGerhardAdvice"].num or 0) == 1:
