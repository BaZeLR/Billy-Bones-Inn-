...
label story_becky_sherwood_road_0(girl_name="becky"):
    ...
    menu:
        "Далее":
            pass
    $ scene_runtime.text = "\"Через него, это верно. Только какой там лес, от него и не осталось почти ничего,\" заметно нервничая ответила вам Ребекка."
    $ scene_runtime.location_text = scene_runtime.text
    menu:
        "Далее":
            pass
    $ scene_runtime.text = "\"А там никто, случаем, не пошаливает? Грабеж, все такое?\" еще более невинно спросили вы."
    $ scene_runtime.location_text = scene_runtime.text
    menu:
        "Далее":
            pass
    $ scene_runtime.text = "\"Ну как тебе сказать,\" смутилась Бекки. \"Дело в том, что да, ты прав, в Куниделл надо ехать через Шервудский лес. Ну, вернее уже не лес, но это не важно.\""
    $ scene_runtime.location_text = scene_runtime.text
    menu:
        "Далее":
            pass
    $ scene_runtime.text = "\"И что?\""
    $ scene_runtime.location_text = scene_runtime.text
    menu:
        "Далее":
            pass
    $ scene_runtime.text = "\"Ну вот, собственно, и все. Там уже давно как эти засели, как их там, обездоленные. Говорят, что мол наша добрая герцогиня в их несчастьях и горькой судьбинушке виновата. Раньше от них вреда особого не было, так, собирали по паре десятков мараведи на пропитание. А недавно разухабились, Эдди моего побили, товар отобрали, лошадь отобрали. Так я и решила, ты паренек смышленный, что-нибудь придумаешь. И мне выгода, и тебе прибыток.\""
    $ scene_runtime.location_text = scene_runtime.text
