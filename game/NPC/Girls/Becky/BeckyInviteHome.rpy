...
label BeckyInviteHome(girl_name="becky"):
    if str(player_state().appearance.current_dress or "") == "citydress" and int(charisma or 0) > 75 and Becky.rel >= 10 and Becky.corruption > 20 and int(DanceStep or 0) >= 3 and int(DanceStep or 0) < int(DanceMaxIBD or 0) and Becky.var.get("danceinvitehome", 0) == 0 and procedural_randint(1, 5, "becky_dance_home_invite_%s_%s" % (dayspassed, DanceStep)) == 1:
