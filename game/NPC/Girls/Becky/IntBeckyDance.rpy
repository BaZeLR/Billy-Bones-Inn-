    ...
    menu becky_dance_menu:
        ...
        "Пригласить потанцевать" if DanceStep == 1:
            ...
            if Friends[GirlNameIBD] >= 7 and sluttiness[GirlNameIBD] > 18:
                ...
                call ShowImage("", "", becky_dance_picture("invite"))
                'Она сказала: "Стефан, Стефан, неужели ты действительно хочешь танцевать с такой практически старухой как я? Я же даже постарше вашей Сандры буду. Ну ладно, если ты так настаиваешь", и она взяла вашу руку и вскоре вы закружились в танце.'
            else:
