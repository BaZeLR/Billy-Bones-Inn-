...
# The label owns the sequential voyeur scene and its native Ren'Py menus.
# ================================================================================
...
label story_becky_church_after_sermon_look:
    ...
    elif Becky.priest_advice_stage == 3 and Becky.home_visit_stage < 7:
    ...
    $ scene_runtime.location_text = scene_runtime.text
    $ scene_runtime.picture = "images/becky/church/cumface.jpg"
    vscene scene_runtime.picture
    "[scene_runtime.text]"
    menu:
        "Вернуться":
