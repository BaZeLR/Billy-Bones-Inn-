...
label AfterDanceSexLegare(CurSexStep=0, tmpLegareSexType=-1, FollowMode=""):
    ...
    if CurSexStep == 0:
        ...
        if Amanda.player_saw_legare_sex and not Amanda.knows_player_saw_legare_sex:
            "У самой калитки Аманда на мгновение задержалась и тихо спросила вас: \"Стефан, ты ведь видел нас с Альберчиком в прошлый раз?\""
            menu:
                "Сказать, что вы все видели":
                    $ Amanda.knows_player_saw_legare_sex = True
                    "Вы подтвердили, что видели их за бочками. Аманда вспыхнула, но лишь упрямо вскинула подбородок и вслед за Легаре скрылась во дворе."
                "Уйти от ответа":
                    "Вы не дали ей прямого ответа. Аманда подозрительно прищурилась, но Легаре уже торопил ее войти во двор."
