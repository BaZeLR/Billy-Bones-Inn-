...
label AmandaAtGloryHole_menu:
    ...
    menu:
        ...
        "Отругать" if _amanda_glory_state <= 2 or _amanda_glory_state == 4:
            ...
            if (Amanda.corruption >= 35 and procedural_randint(1, 2, key="procedural:NPC/Girls/Amanda/AmandaAtGloryHole.rpy:procedural_randint:64:1") == 1) or Amanda.corruption >= 45:
                ...
                $ Liza.change_social(friend_delta=-1, corruption_delta=-1)
            else:
                ...
                $ Liza.change_social(friend_delta=-5, corruption_delta=-2)
        ...
        "Предложить ей сделать то, что она собиралась" if _amanda_glory_state <= 2 or _amanda_glory_state == 4:
            ...
            if Amanda.var_int("knowsexactive", 0) or int(Amanda.sex_stat("sexacts", 0) or 0) >= 3 or int(Amanda.sex_stat("pregnancy", 0) or 0) > 120:
                ...
                $ Amanda.apply_social_chance(15, 1, 1, 45, 1, 1, "glory_hole_suck")
            else:
                ...
                $ Liza.apply_social_chance(10, 1, 1, 40, 1, 1, "glory_hole_suck")
                $ Amanda.apply_social_chance(15, 1, 3, 45, 1, 3, "glory_hole_suck")
        ...
        "Предложить ей продолжить" if _amanda_glory_state == 1:
            ...
            if Amanda.var_int("knowsexactive", 0) or int(Amanda.sex_stat("sexacts", 0) or 0) >= 3 or int(Amanda.sex_stat("pregnancy", 0) or 0) > 120:
                ...
                $ Amanda.apply_social_chance(15, 1, 1, 45, 1, 1, "glory_hole_continue")
            else:
                ...
                $ Liza.apply_social_chance(10, 1, 1, 40, 1, 1, "glory_hole_continue")
                $ Amanda.apply_social_chance(15, 1, 3, 45, 1, 3, "glory_hole_continue")
            $ Amanda.set_var_int("glorysuck", 1)
            $ Amanda.set_var_int("suckyou", 1)
            $ Amanda.set_var_int("gloryscold", 0)
            $ Amanda.set_var_int("glorywalkout", 0)
        ...
        "Трахнуть Аманду" if _amanda_glory_state == 4 or _amanda_glory_state == 5:
            ...
            if Amanda.sex_stat("virginity", True):
                ...
                if int(Amanda.sex_stat("sexacts", 0) or 0) > 15 and int(Amanda.sex_stat("cuminside", 0) or 0) >= 10:
        ...
        "Кончить в Аманду" if _amanda_glory_state == 6:
            ...
            if int(Amanda.sex_stat("cuminside", 0) or 0) < 2:
            ...
            if int(Amanda.sex_stat("pregnancy", 0) or 0) > 120:
                ...
                elif tmpCumInside == 0 and int(Amanda.sex_stat("cuminside", 0) or 0) >= 2:
            ...
            if Amanda.corruption >= 60 or int(Amanda.sex_stat("pregnancy", 0) or 0) > 120:
            ...
            $ Liza.apply_social_chance(10, 1, 1, 40, 1, 1, "glory_hole_first_sex")
        ...
        "Кончить на животик" if _amanda_glory_state == 6:
            ...
            "\"Вся в маму!\" подумали вы. Когда же Лизетта закончила, Аманда оделась, застегнулась, вытерлась, чмокнула вас еще раз и довольная убежала."
            $ Liza.apply_social_chance(10, 1, 1, 40, 1, 1, "glory_hole_sex")
