    ...
    if eyewitness > 0:
        ...
        menu:
            "Строго наругать Аманду за то, та болтает с Лизеттой" if Amanda.var_int("prohibitliza", 0) > 0:
                ...
                $ result = "Вы поймали проходящую мимо Аманду и строго ее отчитали за то, что она болтала с Лизеттой несмотря на запрет. Аманда расплакалась и убежала в слезах."
            ...
            "Сказать Аманде, чтобы не болтала с Лизеттой" if Amanda.var_int("prohibitliza", 0) == 0:
                ...
                $ result = "Вы поймали проходящую мимо Аманду и сказали ей, чтобы она не болтала с Лизеттой, так как та распущенная девчонка и хорошему не научит. Аманда выслушала вас и пообещала с Лизеттой не говорить."
            "Сказать Аманде, что вы погорячились, когда запретили ей говорить с Лизеттой" if Amanda.var_int("prohibitliza", 0) > 0:
                ...
                $ result = "Вы поймали проходящую мимо Аманду и сказали ей, что погорячились, вы не хотите на нее давить и она имеет полное право говорить с кем хочет. Аманда поблагодарила вас за доверие и пошла по своим делам."
