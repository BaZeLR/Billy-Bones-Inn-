...
label InitAmanda:
    python:
        ...
        AmandaVar['attic_window_morning_day'] = -1
        AmandaVar['attic_mock_response_day'] = -1
        AmandaVar['attic_mock_stopped'] = 0
        AmandaVar['attic_mock_exposed'] = 0
        AmandaVar['breakfast_tease_day'] = -1
