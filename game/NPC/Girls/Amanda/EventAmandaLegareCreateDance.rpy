...
init python:
    def event_amanda_legare_create_dance():
        ...
        dance_advance = Amanda.legare_dance_advance_level()
        ...
        if Amanda.legare_departure_code == 0:
        ...
        if Amanda.legare_affection < 12 and procedural_randint(1, 2, key="procedural:NPC/Girls/Amanda/EventAmandaLegareCreateDance.rpy:procedural_randint:35:1") == 1:
