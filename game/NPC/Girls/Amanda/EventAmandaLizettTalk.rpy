    ...
    if eyewitness > 0:
        ...
        menu:
            "Похвалить Аманду, за то, что не стала болтать с Лизеттой" if Amanda.var_int("prohibitliza", 0) > 0 and not_to_speak == 1:
                $ result = "Вы похвалили Аманду за то, что она послушалась вас и не стала болтать с Лизеттой. На ее лице читалось явное облегчение от того, что она не попалась."
            "Строго наругать Аманду за то, та болтает с Лизеттой" if Amanda.var_int("prohibitliza", 0) > 0 and not_to_speak == 0:
                ...
                $ not_to_speak = 1
                $ result = "Вы подошли к болтушкам и начали сурово отчитывать Аманду за то, что она не выполнила вашего наказа. Аманда расплакалась и убежала в слезах."
            ...
            "Сказать Аманде, чтобы не болтала с Лизеттой" if Amanda.var_int("prohibitliza", 0) == 0 and not_to_speak == 0:
                ...
                $ not_to_speak = 1
                $ result = "Вы подошли к болтушкам и вмешались в их разговор, отозвав Аманду в сторону, якобы по неотложному делу. Как только вы остались вдвоем вы сказали Аманде, чтобы она не болтала с Лизеттой, так как та распущенная девчонка и хорошему не научит. Аманда выслушала вас и пообещала с Лизеттой не говорить."
            "Сказать Аманде, что она правильно не стала болтать с Лизеттой" if Amanda.var_int("prohibitliza", 0) == 0 and not_to_speak == 1:
                $ Amanda.set_var_int("prohibitliza", 1)
                $ not_to_speak = 1
                $ result = 'Вы подошли к Аманде и сказали, что случайно слышали ее разговор с Лизеттой. Вы отметили, что она абсолютно правильно не стала с ней болтать и что вы тоже не советуете ей трепаться с юной шлюхой. При слове "шлюха" Аманда зарделась и пообещала с Лизеттой больше не говорить.'
            "Сказать Аманде, что вы погорячились, когда запретили ей говорить с Лизеттой" if Amanda.var_int("prohibitliza", 0) > 0 and not_to_speak == 1:
                ...
                $ result = "Вы подошли к Аманде и сказали, что погорячились, вы не хотите на нее давить и она имеет полное право говорить с кем хочет. Аманда поблагодарила вас за доверие и пошла по своим делам."
            "Подслушать" if not_to_speak == 0:
                $ scene_runtime.text = "Вы решили подслушать, что будет дальше."
                $ scene_runtime.location_text = scene_runtime.text
                menu:
                    "Продолжить подслушивать":
                        pass
                call EventAmandaLizettTalk2(eyewitness)
