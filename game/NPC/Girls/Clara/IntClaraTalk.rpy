    ...
    while _clara_repeat_menu:
        ...
        menu:
            ...
            "Спросить Клариссу о семье" if int(Clara.asked_today or 0) == 0 and int(Clara.rel or 0) >= 6:
                ...
                $ scene_runtime.text = "— У нас не только винная торговля, — объясняет Кларисса. — Элоиза, жена Легаре, профессиональная гувернантка. В доме она держит пансион для взрослых девушек: учит манерам, ведению хозяйства и тому, как держаться в знатном обществе. Со стороны все выглядит очень чинно. Только попробуй неправильно сесть за стол — сразу услышишь замечание."
                menu:
                    "Узнать о пансионе подробнее" if int(Clara.rel or 0) >= 8 and int(Clara.trust or 0) >= 4 and int(threads["claraPaintingsPath"].num or 0) >= 4:
                        $ scene_runtime.text = "— Сейчас у нас живет Полина. Она не дочь Легаре, а взрослая пансионерка: приехала учиться из маленькой далекой деревни. В городе ей все пока непривычно. Элоиза следит за ее речью, походкой, платьем, учит принимать гостей и прислуживать так, чтобы не выглядеть деревенской простушкой. Полина старается, но заученная улыбка у нее порой исчезает при первом неожиданном вопросе, — Кларисса невольно улыбается."
                        menu:
                            "Спросить о будущем воспитанниц" if int(Clara.rel or 0) >= 10 and int(Clara.trust or 0) >= 6 and (threads["claraPaintingsPath"].completed or int(threads["claraPaintingsPath"].num or 0) >= 6):
                                $ scene_runtime.text = "Кларисса понижает голос: — Будущее у всех разное. Одних готовят к замужеству и обязанностям хозяйки дома. Других — в камеристки, компаньонки и старшие служанки к высокой знати. А бывают и те, кто рассчитывает стать наложницей при богатом покровителе. Для каждой Элоиза подбирает свое обучение. Легаре любит говорить о выгодном устройстве, Элоиза — о воспитании. Потому у нас так следят за впечатлением, которое производит девушка: для них это не пустые светские любезности."
                                menu:
