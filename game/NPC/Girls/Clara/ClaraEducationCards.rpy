...
label story_clara_tavern_education_cards_0:
    ...
    $ scene_runtime.text = "Последняя ставка вызывает такой хохот, что Мелисса хватается за край стола, а Кларисса поднимает бутылку, словно кубок. Аманда прячет улыбку за картами и требует реванша. «Только если сумеешь скрыть радость, когда тебе повезёт», — дразнит её Кларисса."
    menu:
        "Продолжить наблюдать":
            pass
        "Уйти":
    ...
    vscene "images/clara/education/cardplay9.jpg"
    $ scene_runtime.text = "Девушки кое-как поправляют одежду, но из-за стола никто не встаёт. Кларисса наклоняется к Аманде и шепчет ей на ухо; та расплывается в улыбке. Мелисса делает вид, что не замечает их сговора, и отпивает вина, не отрывая взгляда от карт."
    menu:
        "Продолжить наблюдать":
            pass
        "Уйти":
    ...
    vscene "images/clara/education/cardplay10.jpg"
    $ scene_runtime.text = "Мелисса вскакивает, торжествуя, и поднимает над головой выигранную вещицу. Аманда прячет лицо в ладони, а Кларисса хлопает победительнице: «Вот это уже была игра, а не одна только удача!»"
    menu:
        "Продолжить наблюдать":
            pass
        "Уйти":
    ...
    vscene "images/clara/education/cardplay11.jpg"
