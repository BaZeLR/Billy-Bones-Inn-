...
label PartEventGirlHarrassmentReaction(GirlNamePEGHR, JobTypePEGHR, EyewitnessPEGHR=0, your_reaction1=0, result="", girl_run_away=0, girl_slapped=0, _girl_info=None, _girl_slut=0, _girl_friend=0, _girl_name="", _girl_name2="", _girl_name3="", _harass_instruction=""):
    $ result = ""
    $ _girl_info = people.get_info(GirlNamePEGHR)
    $ _girl_slut = int(getattr(_girl_info, "corruption", 0) or 0)
    $ _girl_friend = int(getattr(_girl_info, "rel", 0) or 0)
    $ _girl_name = people_display_name(GirlNamePEGHR)
    $ _girl_name2 = people_name(GirlNamePEGHR, 'genitive')
    $ _girl_name3 = people_name(GirlNamePEGHR, 'dative')
    ...
    if your_reaction1 == 3:
        ...
        if _girl_slut <= 10:
            ...
            if _girl_friend < 5 and procedural_randint(1,5, key="procedural:NPC/Girls/Common/PartEventGirlHarrassmentReaction.rpy:procedural_randint:42:3") == 1:
                $ result += f'\nА потом, когда вы отошли в сторону, {_girl_name} поблагодарила вас за помощь.'
                $ _girl_info.change_social(friend_delta=1)
                $ _girl_info.change_mana(1, "harass_player_help")
                $ _girl_info.change_rebellion(-1, "harass_player_help")
        ...
        if (_harass_instruction == 'notallow' and _girl_slut < 45) or (_harass_instruction == '' and _girl_slut < 30):
            ...
            if _girl_slut < 18 and procedural_randint(1, 1 + max((18 - _girl_slut) // 4, 1), key="procedural:NPC/Girls/Common/PartEventGirlHarrassmentReaction.rpy:procedural_randint:84:6") == 1:
    ...
    return (result, girl_run_away, girl_slapped)
# ...existing code...
