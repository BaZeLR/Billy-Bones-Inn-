...
# ================================================================================
label event_waitress_harrass_part2(girl_name, eyewitness=0, your_reaction1=0, harass_type=1, cur_event_desc_part2="", girl_run_away=0, girl_slapped=0, _girl_info=None, girl_slut=0, _girl_reaction_text=""):
