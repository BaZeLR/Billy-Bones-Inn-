...
label ChurchIspoved(entry_arg=0):
    ...
    menu:
        ...
        "В том, что совокуплялись с Жоржеттой" if int(Georgett.sex_stat("sexacts", 0) or 0) > 0 and not story_event_available("Church", "georgett_regular_confession"):
        ...
        "В том, что совокуплялись с Жоржеттой прямо во время службы" if int(Georgett.sex_stat("sexacts", 0) or 0) > 0 and Georgett.story_value("fuckinchurch", 0) and Georgett.story_value("georgettadmit", 0) and not story_event_available("Church", "georgett_service_confession"):
