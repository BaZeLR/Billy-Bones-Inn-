...
# --- GLOBAL DEFAULTS ---
default BeckyHomeFrontRoom.state["inga_scene_stage"] = 0
default BeckyHomeFrontRoom.state["arrival_mode"] = ""
default BeckyHomeFrontRoom.state["inga_scene_roll"] = 1
default BeckyHomeFrontRoom.state["resume"] = False
...
label BeckyHomeFront(arrive_mode=""):
    ...
    $ BeckyHomeFrontRoom.state["arrival_mode"] = str(arrive_mode or "")
    $ BeckyHomeFrontRoom.state["inga_scene_stage"] = 0
    $ BeckyHomeFrontRoom.state["inga_scene_roll"] = procedural_randint(1, 4, key="procedural:Town/BeckyHomeFront.rpy:entry_roll")
    if Becky.story_value("TodayFrontSexCheck", 0) == 1 and BeckyHomeFrontRoom.state["inga_scene_roll"] <= 2:
...
label becky_homefront_share_with_becky:
    ...
    $ show_inga_front_fuck_image(BeckyHomeFrontRoom.state["inga_scene_roll"], 2)
...
label becky_homefront_watch_cum:
    ...
    if BeckyHomeFrontRoom.state["inga_scene_roll"] == 1:
        ...
        $ show_inga_front_fuck_image(3, 2 if BeckyHomeFrontRoom.state["arrival_mode"] == "FromDances" else 1)
    else:
        ...
        $ show_inga_front_fuck_image(2, 2 if BeckyHomeFrontRoom.state["arrival_mode"] == "FromDances" else 1)
    if BeckyHomeFrontRoom.state["arrival_mode"] == "FromDances":
    ...
    if procedural_randint(1,2, key="procedural:Town/BeckyHomeFront.rpy:procedural_randint:326:2") == 1 and BeckyHomeFrontRoom.state["inga_scene_roll"] == 2 and Becky.story_value("IngaSexGreet", 0) == 0 and BeckyHomeFrontRoom.state["arrival_mode"] == "FromDances":
