...
label becky_homefront_share_with_becky:
    ...
    if _becky_inga_first_discovery:
        ...
        "\"Ясно. Я пару раз видел эту милую парочку у бакалейной лавки. Похоже, они любят начинать утро с хорошего минета,\" — заметили вы."
        "Бекки возбужденно хихикнула: \"Вот это я понимаю — правильный завтрак. Хе-хе!\""
    else:
