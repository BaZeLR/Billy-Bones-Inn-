...
label IntBeckyTalkSherwoodApply(girl_name="becky", choice_code=""):
    if str(choice_code or "") == "offer":
        ...
        $ MainTxt = "\"Ой беда-то какая!\" заохала вдова. \"Это тебя Робин ограбил? Я уж думала он не шалит больше, а оно вот как обернулось. Он, Сирик этакий, сыночка моего ведь тоже ограбил. Даже избил. А тебе вишь, повезло, он тебя и не тронул. Так что можно считать легко отделался.\""
