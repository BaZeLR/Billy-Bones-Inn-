...
label IntAlberTalkApply(choice_code=""):
    ...
    if str(choice_code or "") == "reconcile":
        $ MainTxt = "\"Эй, Альбер, чего ты так надулся?\" примирительно сказали вы. \"Ну увидел я тебя с моей сестренкой непутевой, ну вспылил. Ну подрались мы малость, бывает. Все, проехали. \" и вы протянули месье свою руку. Тот немного поколебался, но все-таки ее пожал. \"Ладно, проехали\" согласился он.\n\nВы развернулись, чтобы уйти, но услышали, как месье пробормотал сквозь зубы:"
