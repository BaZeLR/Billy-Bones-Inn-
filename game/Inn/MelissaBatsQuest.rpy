...
label MelissaFindDrawingsScene:
    ...
    $ _drawings_scene_lines = [
        "Утром вы замечаете, как Мелисса, стоя на коленях у кровати Аманды, поспешно шарит рукой под самым низом, будто ищет что-то, что очень не хотелось бы показывать чужим глазам. Услышав шаги, она вздрагивает, краснеет и отстраняется слишком резко.",
