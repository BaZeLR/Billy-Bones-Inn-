...
label Intro:
    ...
    python:
        ...
        _intro_story = "Вас зовут Стефан Лонгкок. Ваш отец, Джон Лонгкок, был крестьянином, но, накопив достаточно денег, он купил небольшой трактир в пригороде большого портового города Коитополиса. Однако ему было не суждено стать трактирщиком - он так увлекся обмытием сделки, что упал пьяным в один из каналов и утонул. После похорон во владение трактиром \"Дикий Жеребец\" вступили вы, его единственный сын и наследник.\n\nК сожалению вы мало что понимаете в уборке, готовке и прочем. Но это не важно, ведь теперь вы управляете трактиром и должны руководить. Основную работу выполняет ваша команда: Сандра, Мелисса и Аманда. Ваше незавидное финансовое положение не позволяет вам пока нанять кого-то еще."
        CurLoc = "Intro"
        location = "Intro"
        PrevLoc = ""
