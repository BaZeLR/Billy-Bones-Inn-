    ...
    menu amanda_dance_menu:
        ...
        "Попросить об одолжении" if DanceStep == 1 and AmandaVar['albernowdances'] == 0 and amanda_can_be_asked_for_night_bowl_favor():
            ...
            if bool(_favor_result.get("granted", False)):
                ...
                "\"Нет уж, братик. Даже с вином в голове я не настолько безумна,\" шепчет Аманда и, смущенно улыбаясь, отмахивается от вашей просьбы."
            jump IntAmandaDance
        ...
        "Продолжить танцевать" if DanceStep >= 2 and DanceStep < DanceMaxIAD and AmandaVar['albernowdances'] == 0:
            ...
            if HandsDance == 'ass':
                "Ваши руки покоятся на попе вашей младшей сестренкии."
            if HandsDance == 'ass2':
        ...
        "Положить руки на талию" if DanceStep >= 2 and DanceStep < DanceMaxIAD and AmandaVar['albernowdances'] == 0 and HandsDance != 'waist':
            ...
            if Friends[GirlNameIAD] >= 6 and sluttiness[GirlNameIAD] > 10:
                ...
                "Ваша сестренка поморщилась, но возражать не стала."
                call SlutFriendsIncrease(GirlNameIAD, 8, 5, 1, 14, 5, 1)
                $ HandsDance = 'waist'
        ...
        "Положить руки на попу" if DanceStep >= 2 and DanceStep < DanceMaxIAD and AmandaVar['albernowdances'] == 0 and HandsDance == 'waist':
            ...
            if Friends[GirlNameIAD] >= 7 and sluttiness[GirlNameIAD] > 18:
                "Сестренка улыбнулась и придвинулась к вам поближе, продолжая танец."
                ...
                '"Стефан, что ты такое делаешь?! Я твоя сестра!" закричала Аманда, с размаху дала вам смачную пощечину, развернулась и ушла, оставив вас в одиночестве.'
                $ DanceStep = DanceMaxIAD
                $ FridayDancesCount += 1
        ...
        "Сжать попу Аманды" if DanceStep >= 2 and DanceStep < DanceMaxIAD and AmandaVar['albernowdances'] == 0 and HandsDance == 'ass':
            ...
            if Friends[GirlNameIAD] >= 10 and sluttiness[GirlNameIAD] > 20:
                "Сестренка улыбнулась и прижалась вплотную к вам, начав тереться своими сисечками о вашу грудь."
                call SlutFriendsIncrease(GirlNameIAD, 11, 4, 1, 22, 3, 1)
                $ HandsDance = 'ass2'
                $ TitsDance = 1
                call ShowImage(GirlNameIAD, "dance", "YouClose")
            elif Friends[GirlNameIAD] >= 8 and sluttiness[GirlNameIAD] >= 16:
                '"Стефанчик, что ты делаешь?! Мы же все таки братик и сестричка" прошептала Аманда, но не сделала ничего, чтобы остановить вас.'
                call SlutFriendsIncrease(GirlNameIAD, 11, 4, 1, 22, 3, 1)
                $ HandsDance = 'ass2'
                call ShowImage(GirlNameIAD, "dance", "YouDance")
        ...
        "Поцеловать Аманду" if DanceStep >= 2 and DanceStep < DanceMaxIAD and AmandaVar['albernowdances'] == 0 and KissDance == 0:
            "Продолжая танцевать, вы вдруг наклонились к сестренке и впились в ее губы своими."
            if Friends[GirlNameIAD] >= 10 and sluttiness[GirlNameIAD] > 21:
                "Сестренка с готовностью ответила на ваш поцелуй, страстно переплетаясь с вами языками."
                ...
                '"Стефанчик, что ты делаешь?! Я же твоя сестра!" прошептала Аманда и отстранилась от вас.'
        ...
        "Предложить Аманде прогулятся" if DanceStep >= 2 and DanceStep < DanceMaxIAD and AmandaVar['albernowdances'] == 0 and HadSex[GirlNameIAD] > 0 and (HandsDance.startswith('ass') or KissDance > 0):
            ...
            if tmpGropeReact == 2:
                "Продолжая танцевать, вы вдруг прошептали сестренке на ушко: 'Милая, а может прогуляемся немного?'"
                ...
                "Продолжая танцевать, вы вдруг прошептали сестренке на ушко: 'Милая, а может прогуляемся немного?'"
                '"Стефан, ты что, предлагаешь мне пойти с тобой в какую-то подворотню? Своей сестре?!" гневно сказала Аманда, развернулась и ушла, оставив вас в одиночестве.'
                $ DanceStep = DanceMaxIAD
                $ FridayDancesCount += 1
                call SlutFriendsIncrease(GirlNameIAD, 0, 1, -1, 0, 1, -1)
                call ShowImage(GirlNameIAD, "dance", "YouDanceAngry")
        ...
        "Вмешаться и разогнать их" if DanceStep >= 1 and DanceStep < DanceMaxIAD + 2 and AmandaVar['albernowdances'] == 1:
            "Нежелая больше смотреть на это непотребство вы решительно подошли к парочке и заявили:\n'Мессир! Что вы себе позволяете?! У вас же есть дети старше Аманды, да и вы женаты! А ты что возомнила?! Разве ты не видишь, что он возрастом как наш отец был бы, будь он жив! А ну, кыш отседа и чтобы больше я такого не видел!'"
            ...
            if AmandaVar['alberfriends'] >= 7:
                "\"Как ты смеешь лезть в мою личную жизнь, братец?! Я уже взрослая и могу сама решать! А Альбер мне очень-очень нравится, ну и что что он женат!\" закричала Аманда и убежала рыдая."
