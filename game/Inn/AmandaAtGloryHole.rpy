...
label AmandaAtGloryHole_menu:
    ...
    menu:
        ...
        "Отругать" if AmandaGloryCurState <= 2 or AmandaGloryCurState == 4:
            ...
            if (sluttiness.get("amanda", 0) >= 35 and renpy.random.randint(1, 2) == 1) or sluttiness.get("amanda", 0) >= 45:
                if AmandaVar.get("glorydeflower", 0) > 0 or AmandaVar.get("fuckyou", 0) > 0:
                    "\"Кто бы говорил братец, кто бы говорил,\" нагло ответила вам Аманда, не отводя взгляда. \"Раньше-то ты совсем по другому пел, когда в меня свою висюльку совал. А теперь он у тебя что, не стоит больше, что ты так разорался? Ну и ори дальше себе, коли так нравится.\""
                elif AmandaVar.get("glorysuck", 0) > 0 or AmandaVar.get("suckyou", 0) > 0:
                    "\"Кто бы говорил братец, кто бы говорил,\" нагло ответила вам Аманда, не отводя взгляда. \"Помниться, когда я у тебя сосала, ты не возражал, а сейчас чегой-то распереживался. Тебе что, вывеска на голову упала али просто солнышко напекло?\""
                else:
                    "\"Кто бы говорил братец, кто бы говорил,\" нагло ответила вам Аманда, не отводя взгляда. \"На словах ты прямо евнух, а на деле здесь бордель устроил, с глорихолом и Лизеттой. Не выросла у тебя указывалка мне указывать, так то братец.\""
                "С этими словами ваша борзая сестра гордо развернулась и вышла. Лизетта же, с интересом выслушав вашу перепалку, лишь пожала плечами. Вы пробормотали Лизетте чтобы она не впутывала вашу сестру в свои дела, но прозвучала ваша речь неубедительно и вы замолкли. Похоже, больше вам здесь делать нечего."
                ...
                "\"Но братик, Лизетта не старше меня, а она умеет так много, я только хотела научится..\" - несмело отвечает вам сестренка.\n\"Молчать, научиться она видите ли хотела! Иди вон отсюда, шлюха! А ты, Лизетта, больше не впутывай мою сестру в свое распутство, понятно?\""
        ...
        "Предложить ей сделать то, что она собиралась" if AmandaGloryCurState <= 2 or AmandaGloryCurState == 4:
            ...
            "С этими словами вы расстегнули штаны и придвинули своего твердеющего друга к губам сестры."
            if AmandaVar.get("gloryscold", 0) or AmandaVar.get("prohibitliza", 0):
            ...
            if sexacts.get("amanda", 0) < 15:
                ...
                "Споро устроившись сестренка начала вполне сноровисто отсасывать у вас, не забывая ласкать ваши яйца."
        ...
        "Предложить ей продолжить" if AmandaGloryCurState == 1:
            call CleanScreenOverflow
            "\"Ах сестренка, сестренка,\" сказали вы. \"Это ведь ты только что у меня отсасывала? Так что же ты остановилась, продолжай же!\" С этими словами вы придвинули свой член, на котором уже блестели капли слюны Аманды к ее губкам."
            if sexacts.get("amanda", 0) < 15:
            ...
            if AmandaVar.get("knowsexactive", 0) or HadSex.get("amanda", 0) >= 3 or pregnancy.get("amanda", 0) > 120:
                "Вы подумали про себя, что Амандочка из недавней пай-девочки быстро превращается, а может уже и превратилась, в маленькую шлюшку, с готовностью сосущую любой член, будь-то член незнакомца или даже брата. Эта мысль, вместе с активной помощью Аманды, довели вас до оргазма."
                call SlutFriendsIncrease("amanda", 15, 1, 1, 45, 1, 1)
            else:
        ...
        "Кончить на лицо" if AmandaGloryCurState == 2:
            call CleanScreenOverflow
            "Перед самым оргазмом вы вытащили член изо рта сестры и кончили ей на лицо. Крупные белые капли потекли по ее щечкам и подбородку, одна струйка попала ей в левый глаз, отчего она зажмурилась, а пара капель осталась в ее белокурых локонах."
        ...
        "Поцеловать Аманду" if AmandaGloryCurState == 4:
            call CleanScreenOverflow
            "Не говоря ни слова, вы наклонились и поцеловали Аманду, чувствуя на ее губах и языке привкус собственной спермы. Сестра с радостью ответила на ваш поцелуй, переплетя ваш язык своим. Продолжая целоваться вы вдруг почуствовали жаркий ротик Лизетты на своем обмякшем было члене. Поцелуи сестры и лизеттин ротик начали быстро приводить вас обратно в полную готовность."
        ...
        "Поблагодарить Аманду" if AmandaGloryCurState == 4:
            call CleanScreenOverflow
            "Вы пылко поблагодарили Аманду, сказав что вам было очень приятно и вы ей очень признательны. Аманда зарделась, пробормотала \"Я тоже люблю тебя, братик\" и убежала."
        ...
        "Трахнуть сестру" if AmandaGloryCurState == 4 or AmandaGloryCurState == 5:
            ...
            if virginity.get("amanda", 0):
                ...
                "Загнав свой член по самые яйца в Аманду вы замерли на секунду, прислушиваясь к своим ощущениям, а потом начали сношать девушку размеренными толчками. Судя по ее громким сладострастным стонам ей такое обращение пришлось по нраву. Сестра самозабвенно подмахивает вам, прижав к себе своими стройными ножками."
                if VirginNotKnow:
        ...
        "Кончить в сестренку" if AmandaGloryCurState == 6:
            call CleanScreenOverflow
            ...
            if pregnancy.get("amanda", 0) > 120:
                ...
                if sluttiness.get("amanda", 0) >= 60:
                    "\"Какой ты пошлый, братец,\" игриво заметила Аманда. \"Не только трахаешь сестренку, но и, похоже, пытаешься меня обрюхатить. Посмотри, сколько ты накончал!\" С этими словами Аманда раздвинула ножки, предоставив вам на обозрение свою полную спермы киску."
