...
label GeorgettBeckyVisit_menu:
    ...
    menu:
        ...
        "Расстегнуть штаны и позвать Бекки" if georgedinnersex == 1 and cametoday < cancumdaily:
            ...
            if sluttiness.get("becky", 0) <= 55:
                ...
                if beckyminetagree > 1:
                    ...
                    "Млея от наслаждения, вы вдруг заметили полный похоти взгляд, которым Эдди одарил свою мамочку."
                    call ShowImageSeq("becky", "dinner", "BeckyMinet", 2)
            else:
                "Вы поймали взгляд вдовы, направленный на ваши вздувшиеся бугром штаны."
                "Облизав губы в предвкушении, Ребекка, не смущаясь присутствием сына и дочки, встала перед вами на колени, приспустила штаны и начала облизывать ваш поднявшийся орган."
                "Млея от наслаждения, вы заметили полный похоти взгляд, которым Эдди одарил свою мамочку, и взгляд, который она ему вернула."
                call ShowImageSeq("becky", "dinner", "BeckyMinet", 2)
        ...
        "Кончить на лицо" if georgedinnersex == 2 and cametoday < cancumdaily:
            ...
            "Вдова, не смущаясь, встретилась взглядом с дочкой и сыном, подмигнула им и только затем вытерла лицо от белых капель вашего семени."
