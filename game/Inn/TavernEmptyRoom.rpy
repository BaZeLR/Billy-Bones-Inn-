...
init 6 python:
    ...
    def tavern_empty_room_description():
        ...
        if Sofa.installed:
            text += "\n\nУ каменной печи стоит старинный диван, доставленный из дома леди Ностар: бордовый бархат, резное дерево и ножки в виде звериных лап. Иногда его резные ножки сами собой переступают по полу, а из обивки доносится приглушенное ворчание."
